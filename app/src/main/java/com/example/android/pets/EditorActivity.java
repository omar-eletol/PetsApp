...
public class EditorActivity extends AppCompatActivity implements  LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Examine the intent that used to lunch this activity
        // to figure out if we are adding a new pet or Editing a pet
        Intent intent = getIntent() ;
        mCurrentPetUri = intent.getData();

        // if the uri is null so we will add a pet
        //if not we are editing the pet
    ...
    private void savePet() {
        ...
        //Get the string from Edit Text and save it in petName
        String petName = mNameEditText.getText().toString().trim();
        //Get the string from Edit Text and save it in petBreed
    ...
    private void deletePet() {
        ...
        if (mCurrentPetUri != null) {
            ...
            // Show a toast message depending on whether or not the delet was successful.
            if (rowsAffected == 0) {
                // If no rows were affected, then there was an error with the update.
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_delete:
                //open the dialog to confirm the delete or cancel it
    ...
    // this method to create the dialog and the positive and negative button
